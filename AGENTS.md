...
This project is indexed by GitNexus as **OmniAgent** (1884 symbols, 5890 relationships, 142 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
