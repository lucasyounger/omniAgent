...
This project is indexed by GitNexus as **OmniAgent** (1874 symbols, 5863 relationships, 142 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
