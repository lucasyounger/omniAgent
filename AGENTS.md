...
This project is indexed by GitNexus as **OmniAgent** (1848 symbols, 5759 relationships, 140 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
