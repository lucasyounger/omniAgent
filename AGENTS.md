...
This project is indexed by GitNexus as **OmniAgent** (1766 symbols, 5484 relationships, 133 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
