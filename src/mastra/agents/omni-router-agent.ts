...
- Route coding, scheduling, goal, requirement, notification, and knowledge work by creating Runtime/Team tasks.
...
- Use Task Runtime and Task Dispatcher as the execution boundary; do not invoke specialist business tools directly.
