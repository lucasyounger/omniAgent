...
const CAPABILITIES: CapabilityDefinition[] = [
  {
    ...
    category: 'repo',
    taskTypes: [runtimeTaskTypes.codeTask, runtimeTaskTypes.codeClaudeCodeTask],
  ...
  },
  {
    ...
    category: 'repo',
    taskTypes: [runtimeTaskTypes.knowledgeDocUpdateProposal, runtimeTaskTypes.codeTask],
  ...
  },
  {
    ...
    category: 'tool',
    taskTypes: [runtimeTaskTypes.codeTask],
  ...
  },
  {
    ...
    standalone: true,
    executables: [
      { kind: 'tool', id: 'create-cron-job', taskTypes: [runtimeTaskTypes.scheduleCreate] },
      { kind: 'tool', id: 'list-cron-jobs', taskTypes: [runtimeTaskTypes.scheduleList] },
      { kind: 'tool', id: 'delete-cron-job', taskTypes: [runtimeTaskTypes.scheduleDelete] },
      { kind: 'tool', id: 'update-cron-job-status', taskTypes: [runtimeTaskTypes.schedulePause, runtimeTaskTypes.scheduleResume] },
      { kind: 'tool', id: 'run-cron-job-now', taskTypes: [runtimeTaskTypes.scheduleRunNow] },
      { kind: 'tool', id: 'create-and-dispatch-runtime-task', taskTypes: [runtimeTaskTypes.scheduleCreate, runtimeTaskTypes.scheduleRunNow] },
    ],
  },
  {
    id: 'message_delivery',
  ...
  },
  {
    ...
    standalone: true,
    executables: [
      { kind: 'tool', id: 'create-runtime-task', taskTypes: [runtimeTaskTypes.goalCreate] },
      { kind: 'tool', id: 'list-runtime-tasks', taskTypes: [runtimeTaskTypes.goalList, runtimeTaskTypes.goalStatus] },
      { kind: 'tool', id: 'create-and-dispatch-runtime-task', taskTypes: [runtimeTaskTypes.goalCreate, runtimeTaskTypes.goalRun, runtimeTaskTypes.goalFeedback, runtimeTaskTypes.goalCronScan] },
      { kind: 'tool', id: 'dispatch-runtime-task', taskTypes: [runtimeTaskTypes.goalRun, runtimeTaskTypes.goalFeedback, runtimeTaskTypes.goalCronScan] },
    ],
  },
  {
    id: 'pr_management',
    ...
    standalone: true,
    executables: [
      { kind: 'tool', id: 'list-pr-pool-items', taskTypes: [runtimeTaskTypes.prPoolList] },
      { kind: 'tool', id: 'get-pr-pool-item' },
      { kind: 'tool', id: 'create-pr-pool-item', taskTypes: [runtimeTaskTypes.prPoolCreate] },
      { kind: 'tool', id: 'ingest-pr-pool-proposal', taskTypes: [runtimeTaskTypes.prPoolIngestProposal] },
      { kind: 'tool', id: 'confirm-pr-pool-item', taskTypes: [runtimeTaskTypes.prPoolConfirm] },
      { kind: 'tool', id: 'develop-pr-pool-item', taskTypes: [runtimeTaskTypes.prPoolDevelop] },
      { kind: 'tool', id: 'scan-pr-pool-ready-items', taskTypes: [runtimeTaskTypes.prPoolCronScan] },
      { kind: 'tool', id: 'archive-pr-pool-item', taskTypes: [runtimeTaskTypes.prPoolArchive] },
      { kind: 'tool', id: 'pause-pr-pool-item' },
      { kind: 'tool', id: 'retry-pr-pool-item' },
      { kind: 'tool', id: 'delete-pr-pool-item' },
    ],
  },
  {
    id: 'req_management',
