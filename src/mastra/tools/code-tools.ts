...
export const startCodeTaskTool = createTool({
  ...
  inputSchema: z.object({
    ...
    executor: z.enum(['claude_code', 'opencode', 'codex', 'custom']).default('claude_code').describe('Code execution backend. claude_code uses cc defaults, opencode and codex use their CLI defaults, and custom uses command overrides.'),
