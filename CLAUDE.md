...
This project is indexed by GitNexus as **OmniAgent** (1904 symbols, 5941 relationships, 144 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
