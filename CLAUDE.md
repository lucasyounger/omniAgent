...
This project is indexed by GitNexus as **OmniAgent** (1798 symbols, 5589 relationships, 136 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
