...
This project is indexed by GitNexus as **OmniAgent** (1725 symbols, 5254 relationships, 130 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
