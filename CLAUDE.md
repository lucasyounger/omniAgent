...
This project is indexed by GitNexus as **OmniAgent** (1820 symbols, 5662 relationships, 137 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
